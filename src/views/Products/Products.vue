...
const lastPage = computed(
    () => products.value.totalCount / Number(perPage.value),
)
...
<template>
    ...
    <div class="bg-white p-4 rounded-lg shadow">
        ...
        <div
            v-if="isLoading"
            class="flex mt-4 w-full justify-center items-center"
        >
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <th
                            class="border-b-2 p-2 text-left cursor-pointer"
                            @click="
                                getProducts(
                                    currentPage,
                                    perPage,
                        ...
                        >
                            <div class="flex justify-center items-center gap-2">
                                Last updated at
                                <svg
                                    v-if="orderBy === SortDirection.ASC"
